...
const TikTokPollCard = ({ poll, onVote, onLike, onShare, onComment, onCreatePoll, isActive, index, total }) => {
...
const TikTokScrollView = ({ polls, onVote, onLike, onShare, onComment, onExitTikTok, onCreatePoll }) => {
